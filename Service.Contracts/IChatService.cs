...
namespace Service.Contracts
{
    public interface IChatService
    {
        ...
        Task<(List<ChatMessageGroupByDateDto> chatMessages, MetaData metaData)> GetChatMessagesAsync(Guid chatId, ChatMessageParameters chatMessageParameters, bool trackChanges);
